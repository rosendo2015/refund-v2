            ...
            <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
                ...
                <form className="space-y-6">
                    <div>
                        ...
                        <input type="email" id="email" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="you@example.com" />
                    </div>
                    <div>
